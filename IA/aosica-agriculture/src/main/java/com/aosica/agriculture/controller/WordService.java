...
import com.aosica.common.util.JsonUtils;
import com.aosica.common.util.MenuUtils;
...
//    private String swaggerUrl;
    ...
    public String test01() {
        try {
            String jsonStr = restTemplate.getForObject("http://localhost:8089/swagger-ui.html", String.class);
        ...
        try {
            ...
            if (paths != null) {
                ...
                while (it.hasNext()) {
                    ...
                    Iterator<Map.Entry<String, LinkedHashMap>> requestIt = value.entrySet().iterator();
                    //不管有几种请求方式，都只解析第一种
                    Map.Entry<String, LinkedHashMap> firstRequest = requestIt.next();
                    ...
                    Iterator<Map.Entry<String, Object>> responseIt = responses.entrySet().iterator();

                    while (responseIt.hasNext()) {
                        Response response = new Response();
                        Map.Entry<String, Object> entry = responseIt.next();
