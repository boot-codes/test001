 ...
 * @Version: 1.0
 */
public class NBServerChannelInitialiazer extends ChannelInitializer<SocketChannel> {
    ...
    public NBServerChannelInitialiazer(WeatherDeviceService weatherDeviceService) {
...
//        socketChannel.pipeline().addLast("encoder", new StringEncoder());
        ...
        // 针对网络请求的业务处理逻辑
        socketChannel.pipeline().addLast(new NBServerHandler(this.weatherDeviceService));
    }
